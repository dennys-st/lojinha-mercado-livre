...
const PRODUTOS = [
    {
        id: 1,
        title: "Baby Doll Canelado de Coração – Confortável e Fresquinho",
        category: "pijamas",
        rating: 4.9,
        ratingCount: 142,
        oldPrice: 59.90,
        ...
        specs: {
            ...
            "Tamanhos": "P, M, G, GG",
            "Estampa": "Corações vermelhos delicados",
            "Tipo": "Pijama baby doll feminino de verão",
            "Diferencial": "Alças ajustáveis e tecido com elasticidade confortável",
            "Recomendação": "Pijama leve ou loungewear para dias de descanso"
        },
